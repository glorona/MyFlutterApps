  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        const SizedBox(height: 20),
        SpinPerfect(infinite: true,duration: const Duration(seconds: 5) , child: const _CustomIconButton(
...
class _CustomIconButton extends StatelessWidget {
  ...
  const _CustomIconButton(
      ...
      : color = iconColor ?? Colors.white; //No se hace color= Colors.white por que se computa, por lo tanto se hace como assert
